...
from models.media.constants import APP_MEDIA_TYPE_WITH_DEFAULT
...
class MediaAccessDefaults(Base):
    ...
    access_type = Column(ChoiceType(APP_MEDIA_TYPE_WITH_DEFAULT), default=None, nullable=True)

    location_list = relationship('MediaAccessDefaultsCountries', backref='media_type', cascade='all, delete')
